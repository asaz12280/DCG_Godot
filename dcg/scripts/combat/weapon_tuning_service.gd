...
static func resolve_snapshot(weapon_def: ItemDef = null, ammo_def: ItemDef = null, attachments: Variant = {}, durability: Variant = {}) -> Dictionary:
	...
	var projectiles_per_shot := weapon_def.get_weapon_projectiles_per_shot()
	...
	var projectile_spread_degrees := weapon_def.get_weapon_projectile_spread_degrees() * attachment_spread
	...
	return {
		...
		"armor_penetration_level": weapon_armor_penetration,
		...
		"vertical_recoil": weapon_vertical,
		"horizontal_recoil": weapon_horizontal,
		...
		"spread_multiplier": attachment_spread,
...
static func _empty_snapshot(weapon_def: ItemDef, ammo_def: ItemDef, attachment_state: Dictionary, durability_state: Dictionary, combat_penalty: Dictionary) -> Dictionary:
	return {
		...
		"weapon_kind": weapon_def.get_weapon_kind() if weapon_def != null else "",
		"uses_ammo": weapon_def.weapon_uses_ammo() if weapon_def != null else false,
		"supports_attachments": weapon_def.weapon_supports_attachments() if weapon_def != null else false,
		"ammo_id": ammo_def.id if ammo_def != null else &"",
		"base_damage": 0.0,
		"damage": 0.0,
		...
		"spread_multiplier": maxf(float(attachment_state.get("spread_multiplier", 1.0)), 0.0),
